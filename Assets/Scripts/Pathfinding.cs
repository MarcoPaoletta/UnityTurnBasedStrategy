...
public class Pathfinding : MonoBehaviour
{
        ...
        while (openList.Count > 0)
        {
            ...
            foreach (PathNode neighbourNode in GetNeighbourList(currentNode))
            {
                ...
                int tentativeGCost = 
                    ...
                    CalculateHeuristicDistance(currentNode.GetGridPosition(), 
    ...
    {
        return Mathf.RoundToInt(Vector3.Distance(gridSystem.GetWorldPosition(gridPositionA), gridSystem.GetWorldPosition(gridPositionB)));
    }
